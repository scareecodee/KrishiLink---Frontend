const BuyerCard = ({ match, onAccept }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow p-4 border border-gray-100">
      <div className="flex justify-between items-start mb-2">
        <h4 className="font-bold text-lg">{match.buyerName}</h4>
      ...
      <div className="mb-4">
        ...
        <p><span className="text-gray-500">Qty:</span> {match.quantity} quintals</p>
        <p><span className="text-gray-500">Price Offered:</span> ₹{match.price}/q</p>
      </div>
      <div className="flex space-x-2">
        ...
        <button onClick={() => onAccept(match)} className="flex-1 bg-primary text-white py-2 rounded font-medium hover:bg-dark">Accept Match</button>
      </div>
    </div>
  );
};
